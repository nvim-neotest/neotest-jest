...
[![license](https://img.shields.io/github/license/nvim-neotest/neotest-jest?style=flat-square&color=blue)](/LICENSE.md)
...
* Current maintainer (as time permits): @MisanthropicBit

## Contributing :gift:

Please see the instructions [here](/CONTRIBUTING.md).

## Bug Reports

Please file any bug reports and I will try to take a look if time permits otherwise please consider submitting a PR as this plugin is intended to be by the community for the community.
